...
export default {
  ...
  ACCOUNTS_INVITE: createRequestTypes('ACCOUNTS_INVITE'),
  ...
  PLATFORMS_REFRESH: createRequestTypes('PLATFORMS_REFRESH'),
  ...
  DIALOG_ACCOUNT_INVITE: 'DIALOG_ACCOUNT_INVITE',
  DIALOG_BOT_CREATE: createDialogTypes('DIALOG_BOT_CREATE'),
  DIALOG_BOT_UPDATE: createDialogTypes('DIALOG_BOT_UPDATE'),
  DIALOG_BOT_DELETE: createDialogTypes('DIALOG_BOT_DELETE'),
